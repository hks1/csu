...
if __name__ == '__main__':
    ...
    print("TOTAL COST".center(width))

    print(f"{item1.item_name} {item1.item_quantity} @ ${item1.item_price} = ${item1.item_price * item1.item_quantity}".center(width))

    print(f"{item2.item_name} {item2.item_quantity} @ ${item2.item_price} = ${item2.item_price * item2.item_quantity}".center(width))
